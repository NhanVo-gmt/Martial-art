...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private Collider2D collisionBlocker;
    ...
    {
        auraState = new PlayerAuraState(core, this, data, stateMachine, "aura");
        blockState = new PlayerBlockState(core, this, data, stateMachine, "block");
        chargeState = new PlayerChargeState(core, this, data, stateMachine, "charge");
        dashState = new PlayerDashState(core, this, data, stateMachine, "dash");
        idleState = new PlayerIdleState(core, this, data, stateMachine, "idle");
        hitState = new PlayerHitState(core, this, data, stateMachine, "hit");
        meleeAttackState = new PlayerMeleeAttackState(core, this, data, stateMachine, "melee attack");
        moveState = new PlayerMoveState(core, this, data, stateMachine, "move");
        rangeAttackState = new PlayerRangeAttackState(core, this, data, stateMachine, "ranged attack");
        skillState = new PlayerSkillState(core, this, data, stateMachine, "skill");
        stunState = new PlayerStunState(core, this, data, stateMachine, "hit");
        superFlightState = new PlayerSuperFlightState(core, this, data, stateMachine, "superFlight");
    }
    ...
    protected void SetPlayerDirectionFromMovementInput()
    {
