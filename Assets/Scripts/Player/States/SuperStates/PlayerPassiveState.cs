...
public class PlayerPassiveState : PlayerState
{
    ...
    public PlayerPassiveState(Core core, Player player, PlayerData data, PlayerStateMachine stateMachine, string animBoolName) : base(core, player, data, stateMachine, animBoolName)
    {
