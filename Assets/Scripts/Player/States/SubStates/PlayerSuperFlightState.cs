...
public class PlayerSuperFlightState : PlayerPassiveState
{
    ...
    public PlayerSuperFlightState(Core core, Player player, PlayerData data, PlayerStateMachine stateMachine, string animBoolName) : base(core, player, data, stateMachine, animBoolName)
    {
